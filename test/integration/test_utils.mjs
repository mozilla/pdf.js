...
function normalizeSpaces(d) {
  // This function is designed for testing the Ink editor, specifically
  // to normalize the content of the 'd' attribute in path elements.
  // It identifies and removes redundant whitespaces around letters
  // in the 'd' parameter, enabling reliable comparison of path data
  // generated by different methods.
  // The curviness and structure of the path remain unaffected
  return d.replace(/\s([\w\W])\s/g, "$1");
}
