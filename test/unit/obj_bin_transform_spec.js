...
describe("obj-bin-transform", function () {
  ...
  describe("FontPath data", function () {
    ...
    if (typeof PDFJSDev !== "undefined" && PDFJSDev.test("MOZCENTRAL")) {
      path = new Float16Array([
        0.214, 0.27, 0.23, 0.33, 0.248, 0.395, 0.265, 0.471, 0.281, 0.54, 0.285,
        0.54, 0.302, 0.472, 0.32, 0.395, 0.338, 0.33, 0.353, 0.27, 0.214, 0.27,
        0.423, 0, 0.579, 0, 0.375, 0.652, 0.198, 0.652, -0.006, 0, 0.144, 0,
        0.184, 0.155, 0.383, 0.155,
      ]);
    } else {
      path = FeatureTest.isFloat16ArraySupported
        ? new Float16Array([
