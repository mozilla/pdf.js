...
describe('network', function() {
  ...
  it('read with streaming', function(done) {
    ...
    var isFirefoxWithMozChunkedEncodingSupport = /Mozilla\/5.0.*?rv:(?:\d+).*? Gecko/.test(userAgent);
    var isFetchWithStreamSupport = (typeof Response !== 'undefined' && 'body' in Response.prototype && typeof ReadableStream !== 'undefined');
