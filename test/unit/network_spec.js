...
describe('network', function() {
  ...
  it('read without stream and range', function() {
    ...
    var disableStream, disableRange;
    var promise = fullReader.headersReady.then(function () {
      disableStream = fullReader.disableStream;
      disableRange = fullReader.disableRange;
    });
    ...
    waitsForPromiseResolved(readPromise, function (page) {
      ...
      expect(disableStream).toEqual(true);
      expect(disableRange).toEqual(true);
    });
  });
  ...
  it('read with streaming', function() {
    ...
    waitsForPromiseResolved(readPromise, function (page) {
      ...
      expect(disableStream).toEqual(false);
    });
  });
  ...
  it('read custom ranges', function () {
    ...
    var disableStream, disableRange, fullReaderCancelled;
    var promise = fullReader.headersReady.then(function () {
      disableStream = fullReader.disableStream;
      disableRange = fullReader.disableRange;
    ...
    waitsForPromiseResolved(readPromises, function (page) {
      ...
      expect(disableRange).toEqual(false);
