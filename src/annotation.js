...
var Annotation = (function AnnotationClosure() {
  ...
  Annotation.prototype = {
    ...
    appendToOperatorList: function Annotation_appendToOperatorList(
      ...
      argsArray.push([data.rect, transform, matrix]);

      var list = evaluator.getOperatorList(this.appearance,
