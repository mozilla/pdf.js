...
class Util {
  static #singularValues = new Float32Array(2);
  ...
  static singularValueDecompose2dScale([m0, m1, m2, m3]) {
    ...
    this.#singularValues[0] = Math.sqrt(first + second || 1);
    this.#singularValues[1] = Math.sqrt(first - second || 1);
