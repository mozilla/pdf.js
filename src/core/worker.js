...
IPDFStreamReader.prototype = {
  /** Gets promise when the headers and other meta information is known about
   * the PDF binary data.
   * @returns {Promise}
   */
   ...
   * the headersReady promise is resolved.
   * @returns {boolean}
   */
  get disableRange() { return false; },
   ...
   * @returns {boolean}
   */
  get disableStream() { return false; },
   ...
   * is set to true, the stream reached the end, otherwise the value contains
   * binary data.
   * @returns {Promise}
   */
  read: function () {},
   ...
   * disableStream property of the object is defined as true.
   */
  onProgress: null,
};
...
var PDFWorkerStream = (function PDFWorkerStreamClosure() {
  function PDFWorkerStream(params, msgHandler) {
    ...
    this._disableRange = params.disableRange || false;
    this._disableStream = params.disableStream || false;
  ...
  PDFWorkerStreamReader.prototype = {
    ...
    get disableRange() {
      return this._stream._disableRange;
    },

    get disableStream() {
      return this._stream._disableStream;
    },
  ...
  createDocumentHandler: function wphCreateDocumentHandler(docParams, port) {
    ...
    function getPdfManager(data) {
      ...
      fullRequest.headersReady.then(function () {
        if (fullRequest.disableStream || fullRequest.disableRange) {
