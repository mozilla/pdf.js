...
(function (root, factory) {
  ...
  function PDFNetworkStreamFullRequestReader(manager, options) {
    ...
    this._disableStream = source.disableStream || false;
  ...
  PDFNetworkStreamFullRequestReader.prototype = {
    ...
    get disableRange() {
      return this._disableRange;
    },

    get disableStream() {
      return this._disableStream;
    },
  ...
  PDFNetworkStreamRangeRequestReader.prototype = {
    ...
    _onProgress: function PDFNetworkStreamRangeRequestReader_onProgress(evt) {
      if (this.disableStream && this.onProgress) {
        this.onProgress({
          loaded: evt.loaded
        });
      }
    ...
    get disableStream() {
      return true; // TODO allow progressive range bytes loading
    },
