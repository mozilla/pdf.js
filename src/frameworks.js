 ...
 */
/* globals PDFJS, require, module, requirejs, __dirname */
...
if (typeof module !== 'undefined') {
  if (module.require) {
    ...
    var fs = require('fs');
    var workerContents = fs.readFileSync(__dirname + '/pdf.worker.js', 'utf8');
    PDFJS.workerSrc = PDFJS.createObjectURL(workerContents);
  }
}
