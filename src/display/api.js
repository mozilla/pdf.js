  ...
  FakeWorkerPort.prototype = {
    postMessage: function (obj, transfers) {
      function cloneValue(value) {
        ...
        if (clonned.has(value)) { // already clonned the object
          return clonned.get(value);
        }
        var result;
        var buffer;
        ...
        clonned.set(value, result); // adding to cache now for cyclic references
