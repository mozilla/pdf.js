...
SVGGraphics = (function SVGGraphicsClosure() {
  ...
  SVGGraphics.prototype = {
    ...
    shadingFill: function SVGGraphics_shadingFill(args) {
      switch (args[0]) {
        ...
        case 'Mesh':
          ...
          break;
        case 'Dummy':
          warn('Unimplemented shading fill Dummy');
          break;
        default:
    ...
    constructPath: function SVGGraphics_constructPath(ops, args) {
      ...
      this._clipAndAppendToGroup(this.current.path);
    ...
    paintSolidColorImageMask:
      ...
      this._clipAndAppendToGroup(rect);
    },
    ...
    paintJpegXObject: function SVGGraphics_paintJpegXObject(objId, w, h) {
      ...
      this._clipAndAppendToGroup(imgEl);
    },
     ...
     * @private
     */
    _clipAndAppendToGroup: function SVGGraphics_clipAndAppendToGroup(element) {
