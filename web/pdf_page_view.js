 ...
 * @property {boolean} enhanceTextSelection - Turns on text enhancement. Default
 * is false.
 */
...
var PDFPageView = (function PDFPageViewClosure() {
  ...
  function PDFPageView(options) {
    ...
    var enhanceTextSelection = options.enhanceTextSelection;
...
//#endif
      ...
      if (this.textLayerFactory) {
        ...
        textLayer = this.textLayerFactory.
          createTextLayerBuilder(textLayerDiv,
                                 this.id - 1,
                                 this.viewport,
