  ...
  _showUINotification(view) {
    ...
    this.l10n
      .get(
        ...
        null,
        "Toggle Sidebar (document contains outline/attachments/layers/speech)"
      )
      .then(msg => {
    ...
    switch (view) {
      ...
      case SidebarView.LAYERS:
        ...
        break;
      case SidebarView.TTS:
        this.ttsButton.classList.add(UI_NOTIFICATION_CLASS);
        break;
    }
  }
    ...
    const removeNotification = sidebarView => {
      switch (sidebarView) {
        ...
        case SidebarView.LAYERS:
          ...
          break;
        case SidebarView.TTS:
          this.ttsButton.classList.remove(UI_NOTIFICATION_CLASS);
          break;
      }
    };
