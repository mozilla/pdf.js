...
const CHARACTERES_ACCENTED_MAP = {
  À: "A",
  Á: "A",
  Â: "A",
  Ã: "A",
...
const CHARACTERES_ACCENTED = new RegExp(
  Object.keys(CHARACTERES_ACCENTED_MAP).join("|"),
  "g"
);

function accentMatch(match) {
  return CHARACTERES_ACCENTED_MAP[match];
}

function removeAccents(string) {
  return string.replace(CHARACTERES_ACCENTED, accentMatch);
}
...
class PDFFindController {
  ...
  _calculateMatch(pageIndex) {
    ...
    if (!accentSensitive) {
      pageContent = removeAccents(pageContent);
