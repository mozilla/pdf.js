...
class SecondaryToolbar {
  ...
  constructor(options, mainContainer, eventBus) {
    ...
    this.buttons = [
      ...
      { element: options.zoomAutomaticButton,
        eventDetails: { value: 'auto', button: 'zoomAutomaticButton', }, eventName: 'scalechanged', close: true, },
      { element: options.zoomPageFitButton,
        eventDetails: { value: 'page-fit', button: 'zoomPageFitButton', }, eventName: 'scalechanged', close: true, },
      { element: options.zoomPageWidthButton,
        eventDetails: { value: 'page-width', button: 'zoomPageWidthButton', }, eventName: 'scalechanged', close: true, },
      { element: options.zoom50Button,
        eventDetails: { value: '0.5', button: 'zoom50Button', }, eventName: 'scalechanged', close: true, },
      { element: options.zoom75Button,
        eventDetails: { value: '0.75', button: 'zoom75Button', }, eventName: 'scalechanged', close: true, },
      { element: options.zoom100Button,
        eventDetails: { value: '1', button: 'zoom100Button', }, eventName: 'scalechanged', close: true, },
      { element: options.zoom150Button,
        eventDetails: { value: '1.5', button: 'zoom150Button', }, eventName: 'scalechanged', close: true, },
    ];
    this.items = {
